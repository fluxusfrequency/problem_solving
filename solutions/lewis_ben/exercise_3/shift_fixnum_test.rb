...
class ShiftFixnumTest < Minitest::Homework
  ...
  # <<
  # Given an integer i,
  # i << n will add n "0" digits to the right side of 
  # the binary representation of that number.

  # So for i == 5,
  # The binary representation is i.to_s(2) == "101"
  # Then i << 1 would give back "1010"
  # and i << 2 would give "10100"

  # Converting those back to integers,
  # "1010".to_i(2) == 10
  # "10100".to_i(2) == 20

  # If the shoveled number is negative, 
  # that many digits are removed from the right side.

  # So for i == 5,
  # The binary representation is i.to_s(2) == "101"
  # Then i << -1 would give back "10"
  # and i << -2 would give "1"
  ...
  # >>
  # Works the same way, except the polarity is reversed.

  # While i << n adds n "0"s to the right side,
  # i >> n removes n digits from the right side.

  # and while i << -n removes n digits,
  # while i >> -n adds n "0"s
